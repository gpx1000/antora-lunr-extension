(function (global, factory) {
  ...
  function searchWithTrie (trie, term, maxDistance) {
    const userTrie = new LevenshteinTrieUser(trie);
    userTrie.searchWithLevenshteinWithData(term.toLowerCase(), maxDistance);
  }
